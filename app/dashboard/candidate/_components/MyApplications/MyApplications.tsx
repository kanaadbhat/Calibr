                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col lg:flex-row lg:items-start gap-4">
                    ...
                    <div className="flex flex-col items-start lg:items-stretch gap-3 lg:max-w-[200px] lg:ml-auto lg:mr-8">
                      ...
                      {/* Start Test Button - Only show if assessment is available and status allows */}
                      {application.assessment && 
                       (application.status === 'applied' || application.status === 'under-review' || application.status === 'shortlisted') && (
                        <Button
                          size="default"
                          className="w-full bg-green-600 hover:bg-green-700 text-white border-green-600 hover:border-green-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-500 focus-visible:ring-offset-gray-950 transition-colors duration-150 px-4 py-2.5 rounded-md shadow-sm"
                          onClick={() => router.push(`/assessment/process/${application.assessment?.assessmentId}`)}
                        >
